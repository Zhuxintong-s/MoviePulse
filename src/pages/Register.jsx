  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 bg-white">
      <div className="bg-white p-8 rounded-3xl shadow-2xl w-full max-w-md border border-gray-100">
        <h1 className="text-3xl font-black mb-2 text-center text-gray-900">Create Account</h1>
        <p className="text-gray-500 text-center mb-8 font-medium">Join the community of movie lovers</p>
        ...
        <p className="mt-8 text-center text-gray-500 font-medium">
          Already have an account? <Link to="/login" className="text-rose-500 hover:underline font-bold">Sign In</Link>
        </p>
      </div>
    </div>
  );
